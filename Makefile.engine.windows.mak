...
ASSEMBLY := engine
EXTENSION := .dll
COMPILER_FLAGS := -g -MD -Wvla -Werror=vla -fdeclspec #-fPIC
...
scaffold: # create build directory
	...
	-@setlocal enableextensions enabledelayedexpansion && mkdir $(addprefix $(OBJ_DIR), $(DIRECTORIES)) 2>NULL || cd .
	-@setlocal enableextensions enabledelayedexpansion && mkdir $(BUILD_DIR) 2>NULL || cd .
	@echo Done.
